...
//	Pocetna i krajnja koordinata se zadaju lijevom tipkom misa, desnom se brise.
...
void myLine1(GLint xa, GLint ya, GLint xb, GLint yb);
void myLine2(GLint xa, GLint ya, GLint xb, GLint yb);
void myLineGlavni(GLint xa, GLint ya, GLint xb, GLint yb);
...
void myLine1(GLint xa, GLint ya, GLint xb, GLint yb) { // od 0 do 90 kutovi
	glBegin(GL_LINES);
	{
...
void myLine2(GLint xa, GLint ya, GLint xb, GLint yb) { // od 0 do -90 kutovi
	glBegin(GL_LINES);
	{
		glVertex2i(xa, ya + 5);			//	crtanje gotove linije
		glVertex2i(xb, yb + 5);
...
void myMouse(int button, int state, int x, int y) {
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN) {
		...
		if (Ix == 0)	myLineGlavni((int)Lx[0], (int)Ly[0], (int)Lx[1], (int)Ly[1]);
