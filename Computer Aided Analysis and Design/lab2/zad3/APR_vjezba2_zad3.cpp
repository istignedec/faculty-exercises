...
int main() {
	...
	double n = 2;
	vector<double> x0_3;
	x0_3.push_back(5); // pocetna tocka
	x0_3.push_back(5);
	vector<double> Dx;
	Dx.push_back(0.5);
	Dx.push_back(0.5);
	...
	min = hooke_jeeves(x0_3, Dx, e_3, fja4);
	...
	n = 2;
	vector<double> x0_4;
	x0_4.push_back(5); // pocetna tocka
	x0_4.push_back(5);
	double e4 = 0.000001, pomak = 0.01, alfa = 1, beta = 0.5, gamma = 2, sigma = 0.5;
	vector<double> min_4;

	min_4 = simplex(x0_4, e4, pomak, alfa, beta, gamma, sigma, fja4_2);
	...
	int poziv1f4 = fja4.getBr();
	int poziv2f4 = fja4_2.getBr();

	printf("\nBroj poziva funkcije 4- HJ : %d", poziv1f4);
	printf("\nBroj poziva funkcije 4- SIMPLEX : %d", poziv2f4);
	printf("\n");
