...
int main() {
	...
	// KOORDINATNO TRAŽENJE FUNKCIJA 3
	vector<double> x0;
	vector<double> e;
	
	double h = 0.1;
	int n = 5;
	x0.push_back(0); // pocetna tocka
	x0.push_back(0);
	x0.push_back(0);
	x0.push_back(0);
	x0.push_back(0);
	...
	xmin = koordinatno_trazenje(x0, e, h, fja31);
	printf("\nKoordinate tocke minimuma FUNKCIJA 3, PO KOORDINATNIM OSIMA:\n");
	for (int i = 0; i < n; i++) {
		printf("%f ", xmin[i]);
	}
	
	// HOOKE-JEEVES POSTUPAK FUNKCIJA 3

	funkcija3 fja32;
	n = 5;
	vector<double> x0_3;
	x0_3.push_back(0); // pocetna tocka
	x0_3.push_back(0);
	x0_3.push_back(0);
	x0_3.push_back(0);
	x0_3.push_back(0);
	...
	min = hooke_jeeves(x0_3, Dx, e_3, fja32);
	printf("\n\nPronadjena tocka minimuma FUNKCIJA 3, POSTUPAK HJ:\n");
	for (int i = 0; i < n; i++) {
		printf(" %f", min[i]);
	}
	printf("\n");

	// SIMPLEX POSTUPAK FUNKCIJA 3
	...
	min_4 = simplex(x0_4, e4, pomak, alfa, beta, gamma, sigma, fja33);
	printf("\n\nPronadjena tocka minimuma, FUNKCIJA 3 SIMPLEX :\n");
	for (int i = 0; i < n; i++) {
		printf(" %f", min_4[i]);
	}
	printf("\n");
	...
	int poziv1f3 = fja31.getBr();
	int poziv2f3 = fja32.getBr();
	int poziv3f3 = fja33.getBr();

	printf("\nBroj poziva funkcije 3- PRETRAGA PO KOORD. OSIMA : %d", poziv1f3);
	printf("\nBroj poziva funkcije 3- HJ : %d", poziv2f3);
	printf("\nBroj poziva funkcije 3- SIMPLEX : %d", poziv3f3);
	printf("\n");
